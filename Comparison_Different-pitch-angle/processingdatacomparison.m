...
filename = '80twist_5cycles__300g_comparisson.csv';
...
filename = '70twist_5cycles_300g_comparison.csv';
...
AX1(1).XLim = [0 3000];
AX1(2).XLim = [0 3000];
title('8.83 N-mm Preload Torque- 80 inserted twists')
...
AX1(1).XLim = [0 3000];
AX1(2).XLim = [0 3000];
title('8.83 N-mm Preload Torque- 70 inserted twists')
